# Fit an intermediate model using data with qualitative severity ratings only
#
# Required Files:
# * 'df_v1v2v3_harm.rds'
#
...
saveRDS(perf, "performance_data/perf_qs_1_effects.rds")
